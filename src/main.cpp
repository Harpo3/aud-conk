...
// Obtain name of artwork file from album directory; maybe check for multiple art files
    ...
    //The command is: echo -n $(audtool current-song-filename) | cut -d'/' -f-5 > ~/.local/share/conkydacious/artloc.txt
    ...
    std::string testjpgID1 = exec("\u0065\u0063\u0068\u006f\u0020\u002d\u006e\u0020\u0024\u0028\u0061\u0075\u0064\u0074"
                                  "\u006f\u006f\u006c\u0020\u0063\u0075\u0072\u0072\u0065\u006e\u0074\u002d\u0073\u006f"
                                  "\u006e\u0067\u002d\u0066\u0069\u006c\u0065\u006e\u0061\u006d\u0065\u0029\u0020\u007c"
                                  "\u0020\u0063\u0075\u0074\u0020\u002d\u0064\u0027\u002f\u0027\u0020\u002d\u0066\u002d"
                                  "\u0035\u0020\u003e\u0020\u007e\u002f\u002e\u006c\u006f\u0063\u0061\u006c\u002f\u0073"
    ...
    // find "$(<~/.local/share/conkydacious/artloc.txt)" -iname '*.jpg' > ~/.local/share/conkydacious/arttmp.txt and use this for the full art path
    // Converted the above command from text to unicode using:
    //https://www.easycalculation.com/unit-conversion/text-unicode-converter.php

    std::string testjpgID2 = exec("\u0066\u0069\u006e\u0064\u0020\u0022\u0024\u0028\u003c\u007e\u002f\u002e\u006c"
                                  "\u006f\u0063\u0061\u006c\u002f\u0073\u0068\u0061\u0072\u0065\u002f\u0063\u006f"
                                  "\u006e\u006b\u0079\u0064\u0061\u0063\u0069\u006f\u0075\u0073\u002f\u0061\u0072"
                                  "\u0074\u006c\u006f\u0063\u002e\u0074\u0078\u0074\u0029\u0022\u0020\u002d\u0069"
                                  "\u006e\u0061\u006d\u0065\u0020\u0027\u002a\u002e\u006a\u0070\u0067\u0027\u0020"
    ...
    //for conky use. The command is: for file in $(cat ~/.local/share/conkydacious/arttmp.txt); do cp "$file" ~/.local/share/conkydacious; done
    // Converted the above command from text to unicode using:
    //https://www.easycalculation.com/unit-conversion/text-unicode-converter.php

    std::string artFileCopied = exec("\u0066\u006f\u0072\u0020\u0066\u0069\u006c\u0065\u0020\u0069\u006e\u0020\u0024"
                                     "\u0028\u0063\u0061\u0074\u0020\u007e\u002f\u002e\u006c\u006f\u0063\u0061\u006c"
                                     "\u002f\u0073\u0068\u0061\u0072\u0065\u002f\u0063\u006f\u006e\u006b\u0079\u0064"
                                     "\u0061\u0063\u0069\u006f\u0075\u0073\u002f\u0061\u0072\u0074\u0074\u006d\u0070"
                                     "\u002e\u0074\u0078\u0074\u0029\u003b\u0020\u0064\u006f\u0020\u0063\u0070\u0020"
    ...
    // command: /usr/bin/stat -c%s $(foo=$(echo "$(audtool --current-song-filename)" | sed 's|\(.*\)/.*|\1|'); echo $foo"/folder.jpg") > ~/.local/share/conkydacious/currartsize.txt

    std::string getArtSize = exec("\u002f\u0075\u0073\u0072\u002f\u0062\u0069\u006e\u002f\u0073\u0074\u0061\u0074\u0020"
                                  "\u002d\u0063\u0025\u0073\u0020\u0024\u0028\u0066\u006f\u006f\u003d\u0024\u0028\u0065"
                                  "\u0063\u0068\u006f\u0020\u0022\u0024\u0028\u0061\u0075\u0064\u0074\u006f\u006f\u006c"
                                  "\u0020\u002d\u002d\u0063\u0075\u0072\u0072\u0065\u006e\u0074\u002d\u0073\u006f\u006e"
                                  "\u0067\u002d\u0066\u0069\u006c\u0065\u006e\u0061\u006d\u0065\u0029\u0022\u0020\u007c"
    ...
    std::string getFullTag = exec("\u0069\u0064\u0033\u0074\u0065\u0064\u0020\u002d\u006c\u0020\u0024\u0028\u0061\u0075"
                                  "\u0064\u0074\u006f\u006f\u006c\u0020\u002d\u002d\u0063\u0075\u0072\u0072\u0065\u006e"
                                  "\u0074\u002d\u0073\u006f\u006e\u0067\u002d\u0066\u0069\u006c\u0065\u006e\u0061\u006d"
                                  "\u0065\u0029\u0020\u003e\u0020\u007e\u002f\u002e\u006c\u006f\u0063\u0061\u006c\u002f"
                                  "\u0073\u0068\u0061\u0072\u0065\u002f\u0063\u006f\u006e\u006b\u0079\u0064\u0061\u0063"
